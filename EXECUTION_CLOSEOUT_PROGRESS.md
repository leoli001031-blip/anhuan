...
**状态：完成（PR #19 第五轮 4 项、PR #21 第六轮 2 项、PR #23 第七轮 1 项：审计同事务证明改为 xmin 事务身份）；实库重放 19/19 PASS、离线 184/184**

### 已完成（PR #21 增量）
- [x] 报告页上下文绑定：切客户清列表/弹窗/目标，提交前后代次校验（探针 6/6）
- [x] f1_0026 只插审计表：归档/恢复同事务事件（含 reason/actor），幂等不重复，f1_api 不可篡改（实库 19/19，含跨事务伪造与同事务重复消费拒绝）
