...
> **阶段收口摘要（2026-08-11）：** `P8_COMPLETE_NOT_RELEASE_VERIFIED / TARGETED_TEST_PASSED / INTERNAL_PWA_ONLY / NOT_PRODUCTION`。未做真实浏览器安装或离线 E2E，不能标 `SMOKE_PASSED`；下文保留启动过程。总状态见 [PROJECT_STATUS.md](./PROJECT_STATUS.md)。
