...
async def current_actor_id(
    ...
    if actor_id is None:
        raise HTTPException(status_code=404, detail="P5_MEMBERSHIP_NOT_FOUND")
    return actor_id
...
async def ensure_member(
    ...
    *,
    ...
    if found is None:
        raise HTTPException(status_code=404, detail="P5_OWNER_NOT_FOUND")
...
__all__ = ("current_actor_id", "ensure_member", "row_dict")
