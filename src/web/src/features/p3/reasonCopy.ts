const REASON_COPY: Record<string, string> = {
  EFFECTIVE_REVIEW_READY: "当前人工修订已生效，可用于问答和报告引用",
  EFFECTIVE_REVIEW_REVOKED: "人工确认已撤销，此材料不参与新问答和报告",
  EFFECTIVE_EXTRACTION_READY: "原始提取已完整入库，可用于问答和报告引用",
  EFFECTIVE_EXTRACTION_PARTIAL: "提取不完整，此材料暂不参与问答和报告",
  EFFECTIVE_EXTRACTION_EMPTY: "当前版本没有完整可用的正文",
  EFFECTIVE_EXTRACTION_PENDING: "正在等待原生提取完成",
  EFFECTIVE_SOURCE_UNAVAILABLE: "材料未释放、已被替代或来源状态已变化",
  ...
  MATERIAL_ANALYSIS_REPROCESS_REQUIRED: "材料分析需更新，请重新处理该材料",
  ...
  MATERIAL_INGESTION_CAPABILITY_INVALID: "处理凭证、原件状态或管理员权限已变化，请重新启动安全入库",
  ...
  MATERIAL_INDEX_REPROCESS_REQUIRED: "资料索引需更新，请重新处理该材料",
  ...
  REPORT_SOURCE_INDEX_OUTDATED: "资料索引需更新，请重新处理相关材料后再生成",
